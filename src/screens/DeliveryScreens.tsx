...
export function Screen08IP({ isActive }: ScreenProps) {
  return (
    <DeliveryScreen
      ...
      imageSrc={`${BASE}/img-reuniao-mesa.jpg`}
...
export function Screen09Team({ isActive }: ScreenProps) {
  return (
    <DeliveryScreen
      ...
      imageSrc={`${BASE}/img-correndo-rua.jpg`}
...
export function Screen10Development({ isActive }: ScreenProps) {
  return (
    <DeliveryScreen
      ...
      imageSrc={`${BASE}/img-macbook-pedra.jpg`}
      imagePosition="center center"
    />
  );
}
...
export function Screen11Frameworks({ isActive }: ScreenProps) {
  return (
    <DeliveryScreen
      ...
      imageSrc={`${BASE}/img-moodboard-1.jpg`}
      imagePosition="center center"
    />
  );
}
...
export function Screen12Technology({ isActive }: ScreenProps) {
  return (
    <DeliveryScreen
      ...
      imageSrc={`${BASE}/img-designer-imac.jpg`}
      imagePosition="center top"
    />
  );
}
...
export function Screen13Oracle({ isActive }: ScreenProps) {
  return (
    <DeliveryScreen
      ...
      imageSrc={`${BASE}/img-escritorio-fone.jpg`}
      imagePosition="center center"
    />
  );
}
...
export function Screen14Agent({ isActive }: ScreenProps) {
  return (
    <DeliveryScreen
      ...
      imageSrc={`${BASE}/img-programadora-dual.jpg`}
      imagePosition="center center"
    />
  );
}
...
export function Screen15Manager({ isActive }: ScreenProps) {
  return (
    <DeliveryScreen
      ...
      imageSrc={`${BASE}/img-moodboard-2.webp`}
      imagePosition="center center"
    />
  );
}
